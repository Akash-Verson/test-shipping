...
L10n.load({
    'ar-AE': {
        'PdfViewer' : {
            ...
            'No Matches': 'لقد انتهى البحث في الوثيقة. لم يتم العثور على أي تطابق.',
            'No More Matches': 'انتهى العارض من البحث في المستند. لم يتم العثور على مزيد من التطابقات',
            ...
            'Export XFDF': 'توضيح التصدير إلى ملف XFDF',
            ...
            'Change Page Zoom': 'تغيير تكبير الصفحة',
            'Increase Page Zoom': 'زيادة زووم الصفحة',
            'Decrease Page Zoom': 'تقليل تكبير الصفحة',
            'Total Matches': 'إجمالي المباريات',
            'Client error': 'تم العثور على خطأ من جانب العميل.  يرجى التحقق من رؤوس التخصيص المقدمة في خاصية AjaxRequestSettings وطرق الإجراءات على الويب في خاصية ServerActionSettings.',
            'Cors policy error': 'غير قادر على استرجاع الوثيقة بسبب رابط غير صالح أو قيود الوصول.  يرجى التحقق من عنوان URL للوثيقة والمحاولة مرة أخرى.',
            'Exact Matches': 'مطابقات دقيقة',
            'Import PDF Failed': 'نوع ملف PDF غير صالح أو لم يتم العثور على ملف PDF.  يرجى اختيار ملف PDF صالح',
            'Extract Pages As Separate Files': 'استخراج الصفحات كملفات منفصلة',
            'Delete Pages After Extracting': 'حذف الصفحات بعد الاستخراج',
            'Example: 1,3,5-12': 'مثال: 1، 3، 5-12',
            'Extract Pages': 'استخراج الصفحات',
            'Extract': 'استخراج',
            'Redact Text':'نص محذوف',
            'Close': 'يغلق',
            'Apply Redactions': 'تطبيق التنقيحات',
            'Apply Redaction': 'تطبيق التنقيح',
            'Use Overlay Text': 'استخدام نص التراكب',
            'Font Style': 'نمط الخط',
            'Repeat Overlay Text':'تكرار نص التراكب',
            'Overlay Text': 'نص متراكب',
            'Fill Opacity': 'شفافية التعبئة',
            'Outline Color': 'لون الخطوط الخارجية',
            'Redaction': 'تنقيح',
            'Redact Content': 'سيتم حذف جميع المحتويات المحددة للتنقيح نهائياً من المستند. ولا يمكن التراجع عن هذا الإجراء.',
            'Mark Page Range': 'نطاق الصفحة المحددة',
            'Current Page': 'الصفحة الحالية',
            'Odd Pages Only': 'الصفحات الفردية فقط',
            'Even Pages Only': 'الصفحات الزوجية فقط',
            'Specific Pages': 'صفحات محددة',
            'Redact': 'حجب',
            'Redaction Panel': 'لجنة التنقيح',
            'Redact Pages': 'صفحات التنقيح',
            'Mark for Redaction': 'علامة للتحرير'
        }
    }
});
</script>